...
const tableMetadata = {
  users: {
    ...
    columns: [
      ...
      { key: 'license_id', title: '执照号', type: 'string' as const },
      {
        key: 'role',
        title: '角色',
        type: 'enum' as const,
  ...
  user_profiles: {
    ...
    columns: [
      ...
      { key: 'region', title: '所属区域', type: 'string' as const },
  ...
  items: {
    ...
    columns: [
      { key: 'id', title: 'ID', type: 'number' as const },
      { key: 'title', title: '零件名称', type: 'string' as const },
  ...
  transactions: {
    ...
    columns: [
      ...
      { key: 'seller_id', title: '卖家ID', type: 'number' as const },
      { key: 'item_id', title: '零件ID', type: 'number' as const },
      ...
      { key: 'meet_location', title: '交付地点', type: 'string' as const },
      { key: 'meet_time', title: '交付时间', type: 'date' as const },
      { key: 'created_at', title: '创建时间', type: 'date' as const },
  ...
  categories: {
    ...
    columns: [
      ...
      { key: 'items_count', title: '零件数', type: 'number' as const },
